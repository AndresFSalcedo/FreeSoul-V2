...
import CreateSlide from './CreateSilde';
...
export default function Slides(){
				...
				columns: [
					...
					{title:"Image",
						...
						render: function(data){
							...
							return `<img alt="img" src="${apiRoute}/show-slideImg/${data}" style="width:320px">`
						}
					},
					{title:"Position"},
					{title:"Actions",
						...
						render: function(data){
							...
							return `
								<a href="" class="inputsEdit" data-toggle="modal" data-target="#editSlide" data="${data}">
								...
								<a href="" class="slideDelete" data="${data}">
	...
	return(
		...
		<div className="content-wrapper" style={{minHeight: "494px"}}>
			...
			{/*=============================================
			VENTANA MODAL PARA CREACION DE SLIDE
			=============================================*/}
