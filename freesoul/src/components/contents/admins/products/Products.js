...
export default function Admins() {
	...
	const dataProducts = async()=>{
		...
		const getProducts = await getDataProduct();
		
		
		const dataSet = [];
		

		getProducts.data.forEach((product, index)=>{
				...
				columns: [
					...
					{title:"Actions",
						...
						render: function(data){
							...
							return `
								<a href="" class="inputEdit" data-toggle="modal" data-target="#editProduct" data="${data}">
								...
								<a href="" class="productDelete" data="${data}">
	...
	return(
		...
		<div>
							...
							<div className="card card-info card-outline">
								...
								<div className="card-header">
									...
									<h5 className="m-0">
										...
										<button className="cleanForm btn btn-primary" data-toggle="modal" data-target="#createProduct">New Product</button>
							  	...
							  	<div className="card-body">
						  			...
						  			<table className="dt-responsive table products table-striped" style={{"width":"100%"}}>
			...
			{/* VENTANA MODAL PARA CREATE PRODUCT*/}

			<CreateProduct/>

			{/* VENTANA MODAL PARA EDIT PRODUCT*/}
