...
export default function EditDeleteBlog() {
   ...
   $(document).on('click', '.inputsEdit', function (e) {
      ...
      $('#editId').val(data[0]);
      $('.previsualizationImg').attr(
         'src',
         `${apiRoute}/show-blogImg/${data[1]}`
      );
      $('#newTitle').val(data[2]);
      $('#newIntro').val(data[3]);
      $('#newUrl').val(data[4]);
               ...
               >
                  <div className='modal-body'>
                     ...
                     <div className='form-goup mb-3'>
                        <label className='small text-secondary' htmlFor='image'>
                           *Image size max 2MB and .jpg or .png
                        </label>
                        ...
                        <img
                           alt=''
                           className='mt-2 previsualizationImg img-fluid'
                        />
                     </div>
                        ...
                        <div className='row g-3 align-items-center mb-3'>
                           ...
                           <div className='col-lg-4'>
                              <div className='small text-secondary'>
                                 *Max 100 characters, letters and numbers
                              </div>
                           </div>
                     ...
                     <div className='form-goup '>
                        <div className='row g-3 align-items-center mb-3'>
                           ...
                           <div className='col-lg-4'>
                              <div className='small text-secondary'>
                                 *Max 600 characters, letters and numbers
                              </div>
                           </div>
