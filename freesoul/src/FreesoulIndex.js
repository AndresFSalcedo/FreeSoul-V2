...
import Slider from './components/freesoulIndex/Slider/Slider';
import TabNav from './components/freesoulIndex/Navbar/TabNav';
import Tab from './components/freesoulIndex/Navbar/Tab';
import Footer from './components/freesoulIndex/Footer/Footer';
import HomeBody from './components/freesoulIndex/HomeBody/HomeBody';
import ProductList from './components/freesoulIndex/Product-list/Product-list';
import AboutUs from './components/freesoulIndex/About/AboutUs';
import PictureNosotras from './components/freesoulIndex/About/PicturesNosotras';
//import Modal from 'react-modal';
import ProductDetail from './components/freesoulIndex/ProductDetail/ProductDetail';

function FreesoulIndex() {
